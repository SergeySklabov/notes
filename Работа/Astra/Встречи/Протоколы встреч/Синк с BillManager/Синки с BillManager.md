...
- **VDC + пользователь для Boatsman** - создаётся через BillManager перед запуском ✅ (22.07)
- **IP-адреса Boatsman** - решает через свой IPAM, BillManager не участвует ✅ (22.07)
- **Boatsman - отдельный тип продукта** - не в рамках ВДЦ ✅ (10.07)
- **FreeIPA** - стенд разворачивается, сценарии проверят ✅ (10.07)
- **Тарификация k8s** - базовый расчёт, градация не ранее мая 2027 ✅ (10.07)
- **TMS интеграция с BillManager** - пока не требуется ✅ (10.07)
