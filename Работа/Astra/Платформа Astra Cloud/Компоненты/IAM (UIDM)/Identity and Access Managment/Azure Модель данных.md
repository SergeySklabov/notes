...
# Description
Как работает  [[Работа/Astra/Astra Cloud Platform/Компоненты/IAM (UIDM)/Identity and Access Managment/IAM]] в MS Azure
...
[[Работа/Astra/Astra Cloud Platform/Компоненты/BillManager]]:
