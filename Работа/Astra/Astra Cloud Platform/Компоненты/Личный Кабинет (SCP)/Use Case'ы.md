...
* [UC-SCP-002](https://life.astralinux.ru/pages/viewpage.action?pageId=482127296) — Создать виртуальную машину. Создание ВМ через портал.
...
### Сети
* [UC-SCP !нужно завести номер!](https://life.astralinux.ru/pages/viewpage.action?pageId=661078924) — Создать виртуальную сеть. !нужно завести номер UC-SCP!
* [UC-SCP !нужно завести номер!](https://life.astralinux.ru/pages/viewpage.action?pageId=661078986) — Изменить виртуальную сеть. !нужно завести номер UC-SCP!
**НЕТ UC:** Список сетей.
